...
with st.sidebar:
    selected = option_menu("Main Menu", ["About Project", "Selling Price Prediction", "Status"],
...
if selected == "Selling Price Prediction":
    ...
    with open(r"F:\DS\MDTM20\VS Code\Copper\model.pkl", 'rb') as file_1:
...
if selected == "Status":
    ...
    with open(r"F:\DS\MDTM20\VS Code\Copper\classifier_model.pkl", 'rb') as file_2:
